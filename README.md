...
Use these steps when publishing the project for the first time.
The same checklist is also available in `docs/github_publish.md`.

### 1. Create A Repository

1. Go to GitHub.
2. Click `New repository`.
3. Use the repository name `ai-powered-healthcare-analytics-rag-reporting-assistant`.
4. Choose `Public` if you want other people to view it.
5. Do not add a README, license, or `.gitignore` from GitHub because this project already includes them.
6. Click `Create repository`.

### 2. Check Files Before Upload

Before committing, confirm these files and folders are present:
...
The included `.gitignore` is already set up to exclude common local and generated files.
...
### 5. Review The GitHub Page

After pushing:

1. Open the repository in GitHub.
2. Confirm the README renders correctly.
3. Confirm screenshots appear under the Dashboard Preview section.
4. Confirm source folders are visible.
5. Confirm no personal local paths or private files were uploaded.
